...
import { User, Phone, Mail, Save, AlertTriangle, CheckCircle, Loader, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0B0B0F] text-[#F4F4F7] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <div className="flex items-center">
          <Link 
            href="/" 
            className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-[#8A8A97] hover:text-[#18E7FF] transition-colors"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-4 border-t border-neutral-800/40">
              <Link 
                ...
                className="text-xs font-bold uppercase tracking-wider text-[#18E7FF] hover:underline"
              >
